...
def criar_pdf_em_memoria(dados):
    ...
    class PDF(FPDF):    
        ...
        def add_table(self, df):
            ...
            col_width = 88 # Defina a largura desejada para as células
    ...
    pdf.add_images_in_rows(st.session_state.lista_imagens, num_images_per_row=3, x_start=10, y_start=90, width=40, height=40, spacing=5)
    pdf_buffer = BytesIO()
